...
public:
    ...
    void setupUi(QDialog *game_or_history)
    {
        ...
        game_or_history->resize(426, 457);
...
""));
        ...
        frame->setGeometry(QRect(50, 10, 341, 441));
        frame->setFrameShape(QFrame::NoFrame);
        listView = new QListView(frame);
        listView->setObjectName("listView");
        listView->setGeometry(QRect(50, 240, 256, 192));
        ...
        view_game_history->setGeometry(QRect(60, 110, 231, 31));
        play_new_game = new QPushButton(frame);
        play_new_game->setObjectName("play_new_game");
        play_new_game->setGeometry(QRect(60, 40, 231, 31));
        replay_button = new QPushButton(frame);
        replay_button->setObjectName("replay_button");
        replay_button->setGeometry(QRect(60, 180, 231, 31));
    ...
    void retranslateUi(QDialog *game_or_history)
    {
        ...
        replay_button->setText(QCoreApplication::translate("game_or_history", "replay", nullptr));
    } // retranslateUi
